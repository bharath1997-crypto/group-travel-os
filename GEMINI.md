...
| Live Trip Mode (MapLibre Navigation) | Complete | 2026-07-12 (Removed redundant status pill from landing search bar, added red status indicator dot for idle state transitioning to pulsing green dot when active, and reworked the right-side map tools launcher into a horizontal 5-box glassmorphism dock featuring a 3D Rovi monkey mascot placeholder sitting on top.) |
...
|---|---|---|
| tests/test_auth.py | — | — |
| tests/test_auth_service.py | 17 | 2026-07-12 |
| tests/test_flights.py | 3 | 2026-07-12 |
| tests/test_hotels.py | 3 | 2026-07-12 |
| tests/test_routes.py | — | — |
| tests/test_activities.py | — | — |
| tests/test_buddy.py | — | — |
| tests/test_explore.py | — | — |
| tests/test_live_group.py | Deprecated | 2026-06-25 |
| tests/test_place_media.py | 8 | 2026-07-12 |
| tests/test_places_nearby.py | 7 | 2026-07-12 |
| tests/test_route_intelligence.py | 12 | 2026-07-12 |
| tests/test_live_routing.py | 3 | 2026-07-12 |
