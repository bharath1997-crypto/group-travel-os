...
| Live Trip Mode (MapLibre Navigation) | Complete | 2026-07-18 (Moved tools dock to bottom-left corner (bottom-4 left-4), removed Rovi monkey mascot entirely, stabilized GPS locates with low-accuracy fallback, and redesigned map layers selection as a horizontal scrollable row with an overlay slider.) |
...
|---|---|---|
| tests/test_auth.py | — | — |
| tests/test_auth_service.py | 17 | 2026-07-18 |
| tests/test_flights.py | 3 | 2026-07-18 |
| tests/test_hotels.py | 3 | 2026-07-18 |
| tests/test_routes.py | — | — |
| tests/test_activities.py | — | — |
| tests/test_buddy.py | — | — |
| tests/test_explore.py | — | — |
| tests/test_live_group.py | Deprecated | 2026-06-25 |
| tests/test_place_media.py | 8 | 2026-07-18 |
| tests/test_places_nearby.py | 7 | 2026-07-18 |
| tests/test_route_intelligence.py | 12 | 2026-07-18 |
| tests/test_live_routing.py | 3 | 2026-07-18 |
