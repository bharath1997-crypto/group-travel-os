...
| Live Trip Mode (MapLibre Navigation) | Complete | 2026-07-05 (Redesigned GPS locate button, pulsing HTML user marker, Chicago baseline coordinates, and optimized geolocation timeout/cache parameters.) |
