...
| Live Trip Mode (MapLibre Navigation) | Complete | 2026-07-18 (Refactored control dock to right-side Option B 5-box horizontal layout, separated current-location control, and gated mock friends tracking.) |
