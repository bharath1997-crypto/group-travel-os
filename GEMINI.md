...
| Live Trip Mode (MapLibre Navigation) | Complete | 2026-07-05 (Redesigned GPS locate button & integrated pure Google Maps-style pulsing HTML user marker with Chicago baseline coordinates.) |
