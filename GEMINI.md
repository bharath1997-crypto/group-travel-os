...
| Live Trip Mode (MapLibre Navigation) | Complete | 2026-07-18 (Moved tools dock to bottom-left corner (bottom-4 left-4), removed Rovi monkey mascot entirely, and stabilized GPS locates with low-accuracy fallback.) |
