...
export const COUNTRIES: CountryOption[] = [
  ...
  { name: "Bolivia (Plurinational State of)", iso2: "BO", dial: "591" },
  ...
  { name: "Brunei Darussalam", iso2: "BN", dial: "673" },
  ...
  { name: "China, Hong Kong Special Administrative Region", iso2: "HK", dial: "852" },
  { name: "China, Macao Special Administrative Region", iso2: "MO", dial: "853" },
  ...
  { name: "Democratic People's Republic of Korea", iso2: "KP", dial: "850" },
  ...
  { name: "French Southern Territories", iso2: "TF", dial: "262" },
  ...
  { name: "Holy See", iso2: "VA", dial: "3906" },
  ...
  { name: "Iran (Islamic Republic of)", iso2: "IR", dial: "98" },
  ...
  { name: "Lao People's Democratic Republic", iso2: "LA", dial: "856" },
  ...
  { name: "Micronesia (Federated States of)", iso2: "FM", dial: "691" },
  ...
  { name: "Pitcairn", iso2: "PN", dial: "870" },
  { name: "Poland", iso2: "PL", dial: "48" },
  { name: "Portugal", iso2: "PT", dial: "351" },
  { name: "Puerto Rico", iso2: "PR", dial: "1" },
  { name: "Qatar", iso2: "QA", dial: "974" },
  { name: "Republic of Korea", iso2: "KR", dial: "82" },
  { name: "Republic of Moldova", iso2: "MD", dial: "373" },
  { name: "Romania", iso2: "RO", dial: "40" },
  { name: "Russian Federation", iso2: "RU", dial: "7" },
  ...
  { name: "Saint Martin (French Part)", iso2: "MF", dial: "590" },
  ...
  { name: "Sint Maarten (Dutch part)", iso2: "SX", dial: "1721" },
  ...
  { name: "State of Palestine", iso2: "PS", dial: "970" },
  { name: "Sudan", iso2: "SD", dial: "249" },
  { name: "Suriname", iso2: "SR", dial: "597" },
  { name: "Svalbard and Jan Mayen Islands", iso2: "SJ", dial: "47" },
  { name: "Sweden", iso2: "SE", dial: "46" },
  { name: "Switzerland", iso2: "CH", dial: "41" },
  { name: "Syrian Arab Republic", iso2: "SY", dial: "963" },
  ...
  { name: "United Kingdom of Great Britain and Northern Ireland", iso2: "GB", dial: "44" },
  { name: "United Republic of Tanzania", iso2: "TZ", dial: "255" },
  { name: "United States Virgin Islands", iso2: "VI", dial: "1340" },
  { name: "United States of America", iso2: "US", dial: "1" },
  { name: "Uruguay", iso2: "UY", dial: "598" },
  { name: "Uzbekistan", iso2: "UZ", dial: "998" },
  { name: "Vanuatu", iso2: "VU", dial: "678" },
  { name: "Venezuela (Bolivarian Republic of)", iso2: "VE", dial: "58" },
  { name: "Viet Nam", iso2: "VN", dial: "84" },
  { name: "Wallis and Futuna Islands", iso2: "WF", dial: "681" },
...
export function dialDisplay(dial: string): string {
  return dial ? `+${dial}` : "";
}

export function countryByIso(iso2: string): CountryOption | undefined {
