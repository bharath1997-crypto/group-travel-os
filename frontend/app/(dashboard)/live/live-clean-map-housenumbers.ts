...
export const CLEAN_MAP_HOUSENUMBER_MIN_ZOOM = 17;
...
/** High-zoom house numbers on Clean Map — hidden while driving, visible when zoomed in. */
export function ensureCleanMapHouseNumberLabels(map: MaplibreMap): void {
