  ...
  return (
    <div className="flex min-h-[calc(100vh-80px)] flex-col items-center justify-center bg-[#0F172A] px-6 py-12 text-[#F8FAFC]">
      <div className="w-full max-w-md text-center">
        ...
        <div className="relative mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-tr from-[#0F766E] to-[#14B8A6] shadow-lg shadow-[#0F766E]/30">
        ...
        <div className="mt-12 text-left border-t border-[#1E293B] pt-8">
          ...
          <div className="mt-4 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-sm font-semibold text-white">Share itineraries</h4>
                <p className="text-xs text-[#94A3B8]">All members can view plans and flight statuses.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-base" role="img" aria-label="wallet">💵</span>
              <div>
                <h4 className="text-sm font-semibold text-white">Split bills</h4>
                <p className="text-xs text-[#94A3B8]">No more complex spreadsheets. Split travel costs instantly.</p>
              </div>
            </div>
          </div>
        </div>
