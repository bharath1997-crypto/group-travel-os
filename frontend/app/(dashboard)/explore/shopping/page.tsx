...
const PLACEHOLDERS = [
  { id: "p-sp-1", name: "Magnificent Mile Designer Tour", category: "Shopping", venue: "Michigan Avenue", city: "Chicago", price_min: 0, price_max: 0, date: "Open daily" },
  { id: "p-sp-2", name: "Woodfield Premium Outlet Hop", category: "Shopping", venue: "Woodfield Mall", city: "Schaumburg", price_min: 0, price_max: 0, date: "Open daily" },
  { id: "p-sp-3", name: "Fashion Outlets Shuttle", category: "Shopping", venue: "Fashion Outlets Rosemont", city: "Rosemont", price_min: 5, price_max: 10, date: "Daily departures" },
  { id: "p-sp-4", name: "State Street Historic Shops", category: "Shopping", venue: "State Street", city: "Chicago", price_min: 0, price_max: 0, date: "Open daily" },
  { id: "p-sp-5", name: "Maxwell Street Vintage Market", category: "Shopping", venue: "Maxwell Street Market", city: "Chicago", price_min: 0, price_max: 0, date: "Sundays only" },
];
            ...
            return (
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden bg-slate-100">
                  <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-violet-400 to-purple-600 opacity-80">
                    <Calendar size={32} className="text-white opacity-40" />
                  </div>
                  <span className="absolute left-3 top-3 rounded-lg bg-white/95 px-2 py-0.5 text-[9px] font-semibold text-violet-700 shadow-sm backdrop-blur">
                    {ev.category}
                  </span>
                ...
                <div className="flex flex-1 flex-col p-3">
                  <h3 className="mb-1 line-clamp-1 text-[13px] font-bold leading-snug text-[#1E293B] group-hover:text-violet-700">
                    {ev.name}
                  </h3>
    ...
    <div className="p-6 bg-[#F8FAFC] min-h-screen">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500">Curated boutique areas in {city}</p>
        </div>
      </div>
      ...
      <div className="mb-8 flex items-start gap-3 rounded-xl border border-blue-100 bg-blue-50 p-4 text-blue-800 shadow-sm">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-blue-700 leading-relaxed">
            We are currently expanding our network to integrate local shopping districts, luxury boutiques, outlet centers, and historical flea markets in {cityLabel(city)}. Explore the preview destinations below!
          </p>
        </div>
      </div>

      <div>
        {renderGrid("Top 100", "The absolute best shopping spots rated by visitors")}
        ...
        {renderGrid("Regional Picks", "Shopping spots within your immediate area")}
        {renderGrid("International & National Picks", "Standout shopping centers across different travel destinations")}
      </div>
    </div>
  );
}
