...
const PLACEHOLDERS = [
  { id: "p-pk-1", name: "Lincoln Park Conservatory Tour", category: "Parks & Outdoors", venue: "Lincoln Park", city: "Chicago", price_min: 0, price_max: 0, date: "Open daily" },
  { id: "p-pk-2", name: "Garfield Park Lagoon Rowboats", category: "Parks & Outdoors", venue: "Garfield Park", city: "Chicago", price_min: 15, price_max: 25, date: "Seasonal schedules" },
  { id: "p-pk-3", name: "Grant Park Formal Rose Gardens", category: "Parks & Outdoors", venue: "Grant Park", city: "Chicago", price_min: 0, price_max: 0, date: "Open daily" },
  { id: "p-pk-4", name: "Jackson Park Japanese Gardens", category: "Parks & Outdoors", venue: "Jackson Park", city: "Chicago", price_min: 0, price_max: 0, date: "Open daily" },
  { id: "p-pk-5", name: "Promontory Point Beach Picnic", category: "Parks & Outdoors", venue: "Promontory Point", city: "Chicago", price_min: 0, price_max: 0, date: "Open daily" },
];
            ...
            return (
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden bg-slate-100">
                  <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-emerald-400 to-teal-600 opacity-80">
                    <Calendar size={32} className="text-white opacity-40" />
                  </div>
                  <span className="absolute left-3 top-3 rounded-lg bg-white/95 px-2 py-0.5 text-[9px] font-semibold text-emerald-700 shadow-sm backdrop-blur">
                    {ev.category}
                  </span>
                ...
                <div className="flex flex-1 flex-col p-3">
                  <h3 className="mb-1 line-clamp-1 text-[13px] font-bold leading-snug text-[#1E293B] group-hover:text-emerald-700">
                    {ev.name}
                  </h3>
      ...
      <div className="mb-8 flex items-start gap-3 rounded-xl border border-blue-100 bg-blue-50 p-4 text-blue-800 shadow-sm">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-blue-700 leading-relaxed">
            We are currently expanding our network to integrate local parks, conservatories, gardens, beaches, and outdoor recreational areas in {cityLabel(city)}. Explore the preview destinations below!
          </p>
        </div>
      </div>

      <div>
        {renderGrid("Top 100", "The absolute best parks and outdoor spots rated by visitors")}
        ...
        {renderGrid("Regional Picks", "Parks within your immediate area")}
        {renderGrid("International & National Picks", "Standout parks across different travel hubs")}
      </div>
    </div>
  );
}
