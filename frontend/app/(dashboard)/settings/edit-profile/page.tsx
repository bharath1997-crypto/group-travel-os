    ...
    <>
      ...
      <div className="mx-auto max-w-lg px-4 py-4">
        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-4">
          ...
          <div className="flex items-start gap-3 rounded-xl border border-slate-200 bg-white p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">
                When off, your name is hidden on trip previews (counts still show).
              </p>
            </div>
          </div>
          ...
          <div>
            <label htmlFor="set-full" className={labelCls}>
              Full name
            </label>
            <input
              id="set-full"
          ...
          <div>
            <label htmlFor="set-username" className={labelCls}>
              Username
            </label>
            <input
              id="set-username"
          ...
          <div>
            <label htmlFor="set-country" className={labelCls}>
          ...
          <div>
            <label htmlFor="set-recovery" className={labelCls}>
          ...
          <div>
            <label htmlFor="set-avatar" className={labelCls}>
